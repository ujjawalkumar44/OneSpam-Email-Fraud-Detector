...
# Try loading images if they exist
ocean_bg = get_base64_of_bin_file("assets/thousand_sunny_bg.png")

zoro_slash_b64 = get_base64_of_bin_file("assets/zoro_slash.png")
luffy_thumbsup_b64 = get_base64_of_bin_file("assets/luffy_thumbsup.png")
nami_attack_b64 = get_base64_of_bin_file("assets/nami_attack.png")
sanji_kick_b64 = get_base64_of_bin_file("assets/sanji_kick.png")
chopper_happy_b64 = get_base64_of_bin_file("assets/chopper_happy.png")
robin_detective_b64 = get_base64_of_bin_file("assets/robin_detective.png")
franky_super_b64 = get_base64_of_bin_file("assets/franky_super.png")
jolly_roger_b64 = get_base64_of_bin_file("assets/jolly_roger.png")
luffy_sprite_b64 = get_base64_of_bin_file("assets/luffy_sprite.png")
zoro_sprite_b64 = get_base64_of_bin_file("assets/zoro_sprite.png")

zoro_slash_src = f"data:image/png;base64,{zoro_slash_b64}"
luffy_happy_src = f"data:image/png;base64,{luffy_thumbsup_b64}"
nami_src = f"data:image/png;base64,{nami_attack_b64}"
sanji_src = f"data:image/png;base64,{sanji_kick_b64}"
chopper_src = f"data:image/png;base64,{chopper_happy_b64}"
robin_src = f"data:image/png;base64,{robin_detective_b64}"
franky_src = f"data:image/png;base64,{franky_super_b64}"
jolly_src = f"data:image/png;base64,{jolly_roger_b64}"
...
.stApp {{
    background-image: url("data:image/png;base64,{ocean_bg}");
    background-size: cover;
    background-position: center;
    background-attachment: fixed;
    animation: panBackground 30s infinite alternate linear, oceanPulse 15s infinite alternate ease-in-out;
...
.onespam-logo .logo-text .skull-o {{
    ...
    width: 90px;
    height: 90px;
    background-image: url("data:image/png;base64,{jolly_roger_b64}");
...
with st.sidebar:
    ...
    <div class="sidebar-brand">
        <img src="data:image/png;base64,{jolly_roger_b64}" alt="Straw Hat Jolly Roger"/>
        <h2>☠️ OneSpam AI</h2>
...
if selection == NAV_HOME:
    ...
    if analyze_clicked:
        if email_text.strip() == "":
            ...
            with st.spinner("⚔️ Zoro's three-sword style… slicing through spam syntax…"):
                time.sleep(1.5) # Simulate processing time for animation
                ...
                if prediction == 1:
                        ...
                        <div class='glass-card danger-glow' style='text-align: center;'>
                            ...
                            <div style="display: flex; justify-content: center; gap: 40px; align-items: center; margin: 20px 0; flex-wrap: wrap;">
                                <div style="text-align: center;">
                                    <img src="{zoro_slash_src}" class="zoro-anim" alt="Zoro">
                                    <p style="margin: 5px 0 0 0; font-weight: bold; color: #ff9f43;">Zoro: Santoryu — spam cut down!</p>
                                </div>
                                <div style="text-align: center;">
                                    <img src="{nami_src}" class="nami-anim" alt="Nami">
                    ...
                    st.markdown(f"""
                        <div class='glass-card safe-glow' style='text-align: center;'>
                            ...
                            <div style="display: flex; justify-content: center; gap: 40px; align-items: center; margin: 20px 0; flex-wrap: wrap;">
                                <div style="text-align: center;">
                                    <img src="{luffy_happy_src}" class="luffy-anim" alt="Luffy">
                                    <p style="margin: 5px 0 0 0; font-weight: bold; color: #55efc4;">Luffy: Meat party approved!</p>
                                </div>
                                <div style="text-align: center;">
                                    <img src="{chopper_src}" class="luffy-anim" alt="Chopper">
            ...
            st.error("⚓ Models missing! Train the crew in the notebook and place model.pkl in models/.")
    st.markdown("</div>", unsafe_allow_html=True)
    ...
    if len(st.session_state.history) == 0:
        ...
        <div class="wanted-poster" style="text-align:center;">
            <img src="{robin_src}" style="max-height:120px;" alt="Robin"/>
    ...
    if len(st.session_state.history) > 0:
        ...
        <div style="text-align:center; margin-top:12px;">
            <img src="{franky_src}" style="max-height:100px;" alt="Franky"/>
        ...
        st.markdown(f"""
        <div class="wanted-poster" style="text-align:center;">
            <img src="{nami_src}" style="max-height:120px;" alt="Nami"/>
